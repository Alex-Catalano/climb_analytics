#(venv) alex@Alexs-MacBook-Pro climb_analytics % python3 analyze_clip_yolov8_pose_climb_v5.py climbing_clip_1.mp4 --out outputs --telemetry --telemetry-h264

#(venv) alex@Alexs-MacBook-Pro climb_analytics %  python3 analyze_clip_yolov8_pose_climb_v5.py climbing_clip_1.mp4 --out outputs --telemetry --telemetry-h264 
#more accuracy for jumps


# analyze_clip_yolov8_pose_climb_v5.py
...
#
# Run (recommended):
#   python3 analyze_clip_yolov8_pose_climb_v5.py climbing_clip_1.mp4 --out outputs --telemetry --telemetry-h264
#
# If you want more accuracy (slower):
#   python3 analyze_clip_yolov8_pose_climb_v5.py climbing_clip_1.mp4 --out outputs --model yolov8s-pose.pt --telemetry --telemetry-h264
#
