...
#(venv) alex@Alexs-MacBook-Pro climb_analytics % python3 analyze_yolov8_climb_active_decay_v3.py climbing_clip_1.mp4 --out outputs --telemetry --telemetry-h264

#(venv) alex@Alexs-MacBook-Pro climb_analytics %  python3 analyze_yolov8_climb_active_decay_v3.py climbing_clip_1.mp4 --out outputs --telemetry --telemetry-h264 
#more accurate?

# analyze_yolov8_climb_active_decay_v3.py
